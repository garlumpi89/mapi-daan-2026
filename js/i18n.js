...
const I18N = {
  es: {
    ...
    "rsvp.contactName": "Nombre de contacto",
    "rsvp.contactName.placeholder": "Nombre de la persona que rellena el formulario",
    ...
    "rsvp.q3": "Nombres y apellidos de los asistentes",
    "rsvp.q3.placeholder": "Escribe los nombres del resto de asistentes separados por comas",
    ...
    "rsvp.q6.hint": "Aparecerán automáticamente el nombre de contacto y el resto de asistentes para indicar menú y alergias por persona.",
    "rsvp.q6.empty": "Añade los nombres de los asistentes para indicar menú y alergias por persona.",
    "rsvp.guest": "Invitado",
  ...
  en: {
    ...
    "rsvp.contactName": "Contact name",
    "rsvp.contactName.placeholder": "Name of the person completing the form",
    ...
    "rsvp.q3": "Full names of the guests",
    "rsvp.q3.placeholder": "Write the remaining guests’ full names separated by commas",
    ...
    "rsvp.q6.hint": "The contact name and the remaining guests will appear automatically so you can add menu and allergy details per person.",
    "rsvp.q6.empty": "Add the guests’ names to enter menu and allergy details per person.",
    "rsvp.guest": "Guest",
  ...
  nl: {
    ...
    "rsvp.contactName": "Naam contactpersoon",
    "rsvp.contactName.placeholder": "Naam van de persoon die het formulier invult",
    ...
    "rsvp.q3": "Voor- en achternamen van de gasten",
    "rsvp.q3.placeholder": "Schrijf de namen van de overige gasten, gescheiden door komma's",
    ...
    "rsvp.q6.hint": "De contactpersoon en de overige gasten verschijnen automatisch, zodat je per persoon menu en allergieën kunt invullen.",
    "rsvp.q6.empty": "Voeg de namen van de gasten toe om per persoon menu en allergieën in te vullen.",
    "rsvp.guest": "Gast",
